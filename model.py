...
def main():
    parser = argparse.ArgumentParser(description='Car Behavioral Cloning Training')
    parser.add_argument('-d', help='data directory',        dest='data_dir',          type=str,   default='./../beta_simulator_linux/data_train/')
